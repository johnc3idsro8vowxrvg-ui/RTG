# Phase 2 数据质量分析报告 [历史归档]

> **⚠️ 本文档为历史归档记录，不作为当前坐标/标定依据。**
> 项目已于 2026-06-15 迁移至 CenterPoint (det3d)，BEV +y 方向已从"集卡侧→禁行侧"翻转为"禁行侧→集卡侧"。
> 本文档中的 TF 坐标、传感器 y 位置、标定表格均为旧坐标系值，不可直接用于当前实现。
> 当前坐标权威来源：**[几何空间与传感器FOV参考手册](./几何空间与传感器FOV参考手册.md)**
>
...
### 5.8 LiDAR-only 模型改造 (TransFusion-L, 2026-05-20) [已废弃]

> **⚠️ 本节约 2026-05-20 的旧方案历史记录。项目已于 2026-06-15 完全迁移至 CenterPoint (det3d)，原生 LiDAR-only，不再需要 SparseFusion 的 lidar_only 改造。**
